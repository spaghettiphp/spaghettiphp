...
<section class="features">
    <div>
        <h2>Como começar</h2>
        <p>Agora você já pode começar a desenvolver sua aplicação com Spaghetti*. Nessa página você encontrará algumas informações de como começar, como estender sua aplicação e como proceder caso você precise de ajuda.</p>
    </div>
    <div>
        <h2>Documentação</h2>
