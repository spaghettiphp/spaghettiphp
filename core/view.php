<?php
/**
 *  A classe View щ responsсvel por extrair o conteњdo enviado pelo controlador
 *  e associс-lo ao view e layout correspondentes, fazendo tambщm a inclusуo
 *  dos helpers necessсrios.
 *
...
class View extends Object {
    ...
    /**
     * View::load_helpers() faz a inclusуo dos helpers necessсrios
     * solicitados anteriormente pelo controlador e que agora serуo usados
     * pela view.
     *
    ...
    /**
     * O mщtodo View::render_view() recebe o resultado do processamento do
     * controlador atual e renderiza a view correspondente, retornando um HTML
     * estсtico do conteњdo solicitado. Chama tambщm o mщtodo responsсvel por
     * extrair os helpers e associс-los ao view.
     *
     * @param string $filename Nome do arquivo de view
     * @param array $extract_vars Variсveis a serem passadas para a view
    ...
    /**
     * View::render() щ responsсvel por receber uma aчуo, um controlador e
     * um layout e fazer as inclusѕes necessсrias para a renderizaчуo da tela,
     * chamando outros mщtodos para renderizar o view e o layout.
     *
     * @param string $action Nome da aчуo a ser chamada
     * @param string $layout Nome do arquivo de layout
     * @return string HTML final da renderizaчуo.
     */
    ...
    /**
     * O mщtodo View::render_layout() faz o buffer e a renderizaчуo do layout
     * requisitado, incluindo a view correspondente a requisiчуo atual e passando
     * as variсveis definidas no controlador. Retorna o HTML processado, sem PHP.
     *
     * @param string $content Conteњdo a ser passado para o layout
     * @param string layout Nome do arquivo de layout
    ...
    /**
     * O mщtodo View::element() retorna o buffer do carregamento de um elemento,
     * que sуo arquivos de views que sуo repetidos muitas vezes, e podem assim
     * estar em um arquivo sѓ. Isto щ bastante њtil para trechos repetidos de
     * cѓdigo PHTML, para que nem seja necessсrio criar um novo layout nem repetir
     * este trecho a cada arquivo onde seja necessсrio.
     *
     * @param string $element Nome do arquivo elemento
     * @param array $params Parтmetros opcionais a serem passados para o elemento
    ...
    /**
     * View::set() щ o mщtodo que grava as variсveis definidas no
     * controlador que serуo passadas para o view em seguida.
     *
     * @param mixed $var String com nome da variсvel ou array de variсveis e valores
     * @param mixed $content Valor da variсvel, щ aceito qualquer tipo de conteњdo
     * @return mixed Retorna o conteњdo da variсvel gravada
     */
